...
_REQUIRED = ("pymupdf", "langchain_core", "langchain_text_splitters",
             "langchain_huggingface", "langchain_community", "faiss",
...
def _relaunch_if_deps_missing() -> None:
    ...
    sys.exit(
        ...
        "langchain-huggingface langchain-community faiss-cpu "
...
class RAGIndex:
    def __init__(self, model_name: str = "BAAI/bge-small-en-v1.5"):
        # Local, open-source embedding model. Normalized vectors so the FAISS
        # L2 distance is a monotone function of cosine similarity.
...
def tune(records: List[Dict[str, Any]]) -> None:
    ...
    FAISS index are rebuilt per configuration.
    """
...
if __name__ == "__main__":
    pdf_filename = "/Users/abubakerahmed/Downloads/pregnancy_cvd_2025.pdf"
